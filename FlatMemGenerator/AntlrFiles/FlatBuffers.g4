...
schema returns [ FlatMemGenerator.FlatBufferTree output ]
@init { $output = new FlatMemGenerator.FlatBufferTree(); }
...
type_decl returns [ FlatMemGenerator.FlatBufferType output ]
@init { $output = new FlatMemGenerator.FlatBufferType(); }
    : ( 'table' { $output.m_kind = FlatMemGenerator.TypeKind.Table; } | 'struct' { $output.m_kind = FlatMemGenerator.TypeKind.Struct; } ) 
...
field_decl returns [ FlatMemGenerator.FlatBufferField output ]
@init { $output = new FlatMemGenerator.FlatBufferField(); }
    : identOne = Ident { $output.m_name = $identOne.text; } 
    ':' 
