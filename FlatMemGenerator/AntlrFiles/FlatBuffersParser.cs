...
public partial class FlatBuffersParser : Parser {
	...
	public partial class SchemaContext : ParserRuleContext {
		public FlatMemGenerator.FlatBufferTree output;
	...
	public SchemaContext schema() {
		...
		EnterRule(_localctx, 0, RULE_schema);
		 _localctx.output =  new FlatMemGenerator.FlatBufferTree(); 
		int _la;
		try {
	...
	public partial class Type_declContext : ParserRuleContext {
		public FlatMemGenerator.FlatBufferType output;
	...
	public Type_declContext type_decl() {
		...
		EnterRule(_localctx, 6, RULE_type_decl);
		 _localctx.output =  new FlatMemGenerator.FlatBufferType(); 
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			...
			case T__4:
				...
				State = 102;
				Match(T__4);
				 _localctx.output.m_kind = FlatMemGenerator.TypeKind.Table; 
				}
				break;
			case T__5:
				{
				State = 104;
				Match(T__5);
				 _localctx.output.m_kind = FlatMemGenerator.TypeKind.Struct; 
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public partial class Field_declContext : ParserRuleContext {
		public FlatMemGenerator.FlatBufferField output;
		public IToken identOne;
	...
	public Field_declContext field_decl() {
		...
		EnterRule(_localctx, 38, RULE_field_decl);
		 _localctx.output =  new FlatMemGenerator.FlatBufferField(); 
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
